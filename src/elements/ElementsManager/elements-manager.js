...
class ElementsManager {
    ...
    loadUnsecureInfoBox() {
        ...
        this.#unsecureEnterBox.innerHTML = this.#unsecureEnterBoxHtml
    ...
    revealInfoBox(isSecure, parentIcon) {
        ...
        this.#infoBox.innerHTML = isSecure ? 'website is secure' : 'not secure website'
